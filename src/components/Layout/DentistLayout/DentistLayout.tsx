...
import { dentistLayoutItem } from "../../../constants/userMenu";
import { useAuth } from "../../../hooks/authHooks/useAuth";
import { LocationData } from "../../../type";
import UserAvatar from "../../UserAvatar/UserAvatar";
import AuthButtons from "../AuthButton/AuthButtons";
import { BgGrey } from "./DentistLayout.style";

const DentistLayout: React.FC = () => {
  // define vars
  const { isAuthenticated, isAuthLoading } = useAuth();
  const location = useLocation();
  const getCurrentKey = () => {
    const item = dentistLayoutItem.find((s) =>
